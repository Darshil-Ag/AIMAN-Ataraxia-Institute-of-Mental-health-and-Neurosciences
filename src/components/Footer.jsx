      ...
      <div className="container-custom pl-4 pr-2 sm:pl-6 sm:pr-4 lg:pl-8 lg:pr-6">
        ...
        <div className="py-12 sm:py-16 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 sm:gap-6 lg:gap-8">
          ...
          <div className="space-y-4 sm:space-y-6 flex flex-col">
            <h3 className="text-lg sm:text-xl font-semibold border-b border-gray-300 pb-2 text-gray-800">Quick Links</h3>
          ...
          <div className="space-y-4 sm:space-y-6 flex flex-col">
            <h3 className="text-lg sm:text-xl font-semibold border-b border-gray-300 pb-2 text-gray-800">Services</h3>
            <ul className="space-y-2 sm:space-y-3">
              <li>
                <button
          ...
          <div className="space-y-4 sm:space-y-6 flex flex-col">
            ...
            <div className="space-y-3 sm:space-y-4">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <a href="tel:+918800833411" className="text-gray-600 text-sm sm:text-base hover:text-primary-600 transition-colors">
                    +91 88008 33411
                  </a>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                ...
                <a href="mailto:info@aimanhealth.com" className="text-gray-600 text-sm sm:text-base hover:text-primary-600 transition-colors break-all">
